...
Die Unterschiede zwischen Simulation und Experiment sind in Figure 10 dargestellt. Es fällt auf das das Experiment durch die nicht ideale Simulation, PT1 näherung und keine Reibung berücksichtigt, signifikant langsammer ist als die Simulation, dies fällt vorallem im Bereich zwischen 1,5 Sekunden und 2 Sekunden auf, wo der Graf der Simulation eine höhere Steigung besitzt.
