...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.2\textwidth]{Drehzahl6e3neu.png}
...
\begin{itemize}
\item Das Ergebnis ist bei einer Führungsgröße von 2000
\begin{align}
% Muss noch geändert werden. Hier müssen Winkel rein.
\Delta m = \frac{2100}{2000} = 1,05\,\frac{U}{s} \,\,und\,\,\, t\textsubscript{5\%} = 1,2\,s.
\end{align}
\item Das Ergebnis ist bei einer Führungsgröße mit 0 gleicht dem Wert der 2000 U/s. Dabei bleibt festzuhalten, dass der Motor einen Error meldet sobald dieser Versuch arbeitet. Dies liegt daran, dass die Stellgrößerenwerte des Motors stark überschritten werden würden.
\end{itemize}

\subsubsection{Implementation und versuch an der Maschine im Praktikum}
Der Test im realen System zeigt eine bedeutend kürzere einschwingzeit und eine bedeutend kleinere Überschwinggröße. Dies ist vorallem mit den sehr hohen Reibungskoeffizienten am Versuchsaufbau zu erklären. Daraus ergibt sich folgendes Diagramm der Drehung um 90 $^\circ$.
\begin{figure}[H]
	\centering
