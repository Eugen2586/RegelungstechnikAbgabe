...
%um diese in den stabilen Bereich zu krümmen.
%dort den zerophilien Anteil der Wurzelortskurve anzuziehen.
...
%\end{figure}
<<<<<<< HEAD
\begin{figure}[H]  %Darauf achten, dass diese Figur an der richtigen Stelle ist
=======
\newpage
\section{Versuch Kran}
\subsection{Vorbereitungsaufgaben}
