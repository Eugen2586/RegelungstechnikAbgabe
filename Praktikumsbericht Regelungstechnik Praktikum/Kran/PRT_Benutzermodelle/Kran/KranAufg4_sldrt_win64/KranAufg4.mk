...
MODEL                := KranAufg4
MODULES              := rt_matrx.c rt_printf.c KranAufg4_data.c KranAufg4_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := KranAufg4.mk
MATLAB_ROOT          := C:/PROGRA~1/MATLAB/R2017a
MATLAB_BIN           := C:/PROGRA~1/MATLAB/R2017a/bin
S_FUNCTIONS          := Crane3D_Encoder.c Crane3D_LimitFlag.c Crane3D_PWM.c Crane3D_PWMPrescaler.c Crane3D_ResetEncoder.c Crane3D_ResetSwitchFlag.c Crane3D_SetLimit.c Crane3D_Switch.c Crane3D_ThermFlag.c
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 1
TID01EQ              := 0
...
#
MODELLIB                  := KranAufg4lib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := KranAufg4_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/prt01/Desktop/PRT_Benutzermodelle/Kran;C:/Users/prt01/Desktop/PRT_Benutzermodelle/Kran/KranAufg4_sldrt_win64;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
