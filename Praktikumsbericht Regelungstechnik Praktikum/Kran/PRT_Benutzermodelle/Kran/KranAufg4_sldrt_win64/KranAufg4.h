...
#ifndef RTW_HEADER_KranAufg4_h_
#define RTW_HEADER_KranAufg4_h_
#include <string.h>
#include <stddef.h>
#include <math.h>
#ifndef KranAufg4_COMMON_INCLUDES_
# define KranAufg4_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* KranAufg4_COMMON_INCLUDES_ */

#include "KranAufg4_types.h"
...
#define KranAufg4_rtModel              RT_MODEL_KranAufg4_T

/* Block signals (auto storage) */
typedef struct {
  real_T Encoder[5];                   /* '<S1>/Encoder' */
  real_T XScale;                       /* '<S1>/X Scale' */
  real_T YScale;                       /* '<S1>/Y Scale' */
  real_T ZScale;                       /* '<S1>/Z Scale' */
  real_T ux;                           /* '<Root>/Constant' */
  real_T YAngleScale;                  /* '<S1>/Y Angle Scale' */
  real_T uy;                           /* '<Root>/Sum' */
  real_T Constant1;                    /* '<Root>/Constant1' */
  real_T LimitSwitch[3];               /* '<S1>/LimitSwitch' */
  real_T LimitSwitchGain[3];           /* '<S1>/LimitSwitchGain' */
  real_T XAngleScale;                  /* '<S1>/X Angle Scale' */
  ...
  real_T ResetSource[5];               /* '<S1>/ResetSource' */
...
typedef struct {
  ...
  real_T DiscreteTransferFcn_states_n; /* '<S3>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn_tmp;      /* '<S2>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn_tmp_e;    /* '<S3>/Discrete Transfer Fcn' */
  struct {
    void *LoggedData;
  ...
  struct {
    void *LoggedData;
  } Stellsignal_PWORK;                 /* '<Root>/Stellsignal' */

  struct {
    void *LoggedData;
  } Switches_PWORK;                    /* '<Root>/Switches' */

  struct {
    void *LoggedData;
  } Winkel_PWORK;                      /* '<Root>/Winkel' */
...
#define rtB                            KranAufg4_B
#define BlockIO                        B_KranAufg4_T
#define rtP                            KranAufg4_P
#define Parameters                     P_KranAufg4_T
#define rtDWork                        KranAufg4_DW
#define D_Work                         DW_KranAufg4_T

/* Parameters (auto storage) */
struct P_KranAufg4_T_ {
  ...
  real_T Constant3_Value_o;            /* Expression: 1
                                        ...
                                        */
  real_T DiscreteTransferFcn_NumCoef[2];/* Expression: [1 -1]
                                         * Referenced by: '<S2>/Discrete Transfer Fcn'
                                         */
  real_T DiscreteTransferFcn_DenCoef[2];/* Expression: [1 Ts]
                                         * Referenced by: '<S2>/Discrete Transfer Fcn'
                                         */
  ...
  real_T Constant2_Value_p;            /* Expression: 0
                                        ...
                                        */
  real_T DiscreteTransferFcn_NumCoef_j[2];/* Expression: [1 -1]
                                           * Referenced by: '<S3>/Discrete Transfer Fcn'
                                           */
  real_T DiscreteTransferFcn_DenCoef_a[2];/* Expression: [1 Ts]
                                           * Referenced by: '<S3>/Discrete Transfer Fcn'
                                           */
  ...
  real_T XAngleScale_Gain;             /* Expression: Crane3D_ScaleCoeff( 4 )
                                        ...
                                        */
  real_T Switch_Threshold;             /* Expression: pi/8
                                        * Referenced by: '<S4>/Switch'
                                        */
  real_T Switch1_Threshold;            /* Expression: pi/8
...
extern P_KranAufg4_T KranAufg4_P;

/* Block signals (auto storage) */
extern B_KranAufg4_T KranAufg4_B;

/* Block states (auto storage) */
extern DW_KranAufg4_T KranAufg4_DW;

/* Model entry point functions */
extern void KranAufg4_initialize(void);
extern void KranAufg4_output(void);
extern void KranAufg4_update(void);
extern void KranAufg4_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern KranAufg4_rtModel *KranAufg4(void);
...
extern RT_MODEL_KranAufg4_T *const KranAufg4_M;
 ...
 *
 * '<Root>' : 'KranAufg4'
 * '<S1>'   : 'KranAufg4/Crane 3D'
 * '<S2>'   : 'KranAufg4/PD-Regler 1'
 * '<S3>'   : 'KranAufg4/PD-Regler 2'
 * '<S4>'   : 'KranAufg4/Crane 3D/Notaus_Winkel'
 */
#endif                                 /* RTW_HEADER_KranAufg4_h_ */
