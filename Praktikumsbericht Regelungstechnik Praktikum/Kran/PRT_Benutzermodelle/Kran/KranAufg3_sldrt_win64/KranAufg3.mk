...
MODEL                := KranAufg3
MODULES              := rt_matrx.c rt_printf.c KranAufg3_data.c KranAufg3_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := KranAufg3.mk
...
#
MODELLIB                  := KranAufg3lib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := KranAufg3_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/prt01/Desktop/PRT_Benutzermodelle/Kran;C:/Users/prt01/Desktop/PRT_Benutzermodelle/Kran/KranAufg3_sldrt_win64;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
